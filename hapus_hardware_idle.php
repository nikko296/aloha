...
border=0 width="1005">
  ...
  <TR vAlign=top bordercolor="1" border="1">
    ...
    <TD width="1000" vAlign=top bordercolor="1" align="center"><div align="center"><BR>
                  ...
                  <TBODY>
                    <TR>
                      <TD width="975"><div align="center"><font color="#800000">
						<b>HAPUS HARDWARE IDLE</b></font></div>    
      ...
      bgColor=#6487dc border=0 height="73">
            <TBODY>
              <TR>
                <TD height="71">
				<FORM method="post" action="hapus_hardware_idle.php">
	...
	<td align="center" bgcolor="#6666FF"><font color="#FFFF00"><b>TGL GGN</b></font></td>
    <td align="center" bgcolor="#6666FF"><font color="#FFFF00"><b>JNS GGN</b></font></td>
...
?>
         <font size="1">
<?php
         print("<CENTER><A HREF=\"simpan_hapus_hardware_idle.php?kode=$kode1\">");
         print("HAPUS IDLE </A></CENTER>");
?>
       </font>
<?php
         print("</TD>");
