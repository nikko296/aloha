...
require ("koneksi.php");
      ...
      // hapus data di tabel master_hw
      // echo "$kode";
      $sql = "delete from table_ggn_hw  where no_sn like '$kode'";
      //echo odbc_error();
      //$hasil= odbc_do($hubung_data_hw, $permintaan);

      if (mysql_query ($sql,$link))
          print("Data dengan NOMOR SERIAL = $kode sudah dihapus dari Database dengan benar dan sukses");
      else
          print("Data dengan NOMOR SERIAL = $kode gagal dihapus dari Database");
     mysql_close($link);
