  ...
  <TR vAlign=top bordercolor="1" border="1">
    ...
    <TD width="90%" vAlign=top bordercolor="1"><BR>
        ...
        <TR>
          <TD>
            ...
            border=0>
              ...
              <TR>
                <TD>
				<p align="center"><b>UBAH HARDWARE IDLE</b></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE><BR>
                  <BR>
      <div align="center">
      <TABLE cellSpacing=1 cellPadding=0 width="90%" align=center 
     ...
     require ("koneksi.php");
      ...
      $sql = "select no_sn,jenis_hw,merk_hw,type_hw,spesifik_hw,tgl_ggn,jns_ggn,inst_perbaikan,almt_inst,ptgs_penerima,biaya,tgl_selesai from table_ggn_hw where no_sn like '$kode%'";
      ...
      $tgl_ggn1 = $baris[5];
      $jns_ggn1 = $baris[6];
      $inst_perbaikan1 = $baris[7];
      $almt_inst1 = $baris[8];
      $ptgs_penerima1 = $baris[9];
      $biaya1 = $baris[10];
      $tgl_selesai1 = $baris[11];

      

?>
             
<form method="post" action="simpan_ubah_hardware_idle.php">
  <tr>
  ...
  <tr>
    <td width="37%" height="24"><font color="#000080">TANGGAL GANGGUAN</font></td>
    <td width="1%" height="24">:</td>
    <td width="56%" height="24">
    <?php
        print("<input type=\"text\" name=\"tgl_ggn\" size=\"50\"");
        print("value=\"$tgl_ggn1\">");
     ?>
    </td>
  </tr>
<tr>
    <td width="37%" height="24"><font color="#000080">JENIS GANGGUAN</font></td>
    <td width="1%" height="24">:</td>
    <td width="56%" height="24">
    <?php
        print("<input type=\"text\" name=\"jns_ggn\" size=\"50\"");
        print("value=\"$jns_ggn1\">");
     ?>
    </td>
  </tr>
<tr>
    <td width="37%" height="24"><font color="#000080">INSTANSI</font></td>
    <td width="1%" height="24">:</td>
    <td width="56%" height="24">
    <?php
        print("<input type=\"text\" name=\"inst_perbaikan\" size=\"50\"");
        print("value=\"$inst_perbaikan1\">");
     ?>
    </td>
  </tr>
<tr>
    <td width="37%" height="24"><font color="#000080">ALAMAT_INSTANSI</font></td>
    <td width="1%" height="24">:</td>
    <td width="56%" height="24">
    <?php
        print("<input type=\"text\" name=\"almt_inst\" size=\"50\"");
        print("value=\"$almt_inst1\">");
     ?>
    </td>
  </tr>
<tr>
    <td width="37%" height="24"><font color="#000080">PETUGAS (PENERIMA)</font></td>
    <td width="1%" height="24">:</td>
    <td width="56%" height="24">
    <?php
        print("<input type=\"text\" name=\"ptgs_penerima\" size=\"50\"");
        print("value=\"$ptgs_penerima1\">");
     ?>
    </td>
  </tr>

  <tr>
    <td width="37%" height="24"><font color="#000080">BIAYA</font></td>
    <td width="1%" height="24">:</td>
    <td width="56%" height="24">
    <?php
        print("<input type=\"text\" name=\"biaya\" size=\"50\"");
        print("value=\"$biaya1\">");
      ?>
    </td>
  </tr>
  ...
  <tr>
    <td width="37%" height="24"><font color="#000080">TANGGAL SELESAI</font></td>
    <td width="1%" height="24">:</td>
    <td width="56%" height="24">
    <?php
        print("<input type=\"text\" name=\"tgl_selesai\" size=\"50\"");
        print("value=\"$tgl_selesai1\">");
      ?>
    </td>
  </tr>
