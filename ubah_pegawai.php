        ...
        <TR>
          <TD>
            ...
            border=0>
              ...
              <TR>
                <TD>
				<p align="center"><b>UBAH DATA PEGAWAI</b></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE><BR>
                  <BR>
      <TABLE cellSpacing=1 cellPadding=0 width="90%" align=center 
...
<form method="post" action="simpan_ubah_data_pegawai.php">
<?php
require ("koneksi.php");
      ...
      // echo "$kode";
     // $sql="SELECT nik,nama,jabatan,loker FROM tabel_pegawai WHERE nik like '%$nik%'";
      $hasil= mysql_query("SELECT nik,nama,jabatan,loker FROM tabel_pegawai WHERE nik like '%$kode%'",$link);
     // echo mysql_error();
     //  $row_num=mysql_num_rows($hasil);
     // if(!$row_num)
...
?>
  ...
  <tr>
    <td width="37%" height="17"><font color="#000080">NIK</font></td>
  ...
  <tr>
    <td width="37%" height="24"><font color="#000080">NAMA</font></td>
    <td width="1%" height="24">:</td>
    <td width="56%" height="24">
    <?php
        print("<input type=\"text\" name=\"nama\" size=\"50\"");
        print("value=\"$nama1\">");
    ?></td>
  </tr>

  <tr>
    <td width="37%" height="23"><font color="#000080">JABATAN</font></td>
    <td width="1%" height="23">:</td>
    <td width="56%" height="23">
    <?php
        print("<input type=\"text\" name=\"jabatan\" size=\"50\"");
        print("value=\"$jabatan1\">");
     ?>
  ...
  <tr>
    <td width="37%" height="8"><font color="#000080">LOKASI KERJA</font></td>
    <td width="1%" height="8">:</td>
    <td width="56%" height="8">
    <?php
        print("<input type=\"text\" name=\"loker\" size=\"50\"");
        print("value=\"$loker1\">");
     ?>
    </td>
  </tr>
