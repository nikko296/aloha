...
require ("koneksi.php");
       ...
       if (!mysql_select_db($dbname,$link))
        ...
        // proses seleksi, bila data sudah ada tdk disimpan.
         $hasil1 = mysql_query("select * from table_pegawai WHERE master_hw.nik like '$nik'", $link);
        ...
        $hasil = "UPDATE tabel_pegawai SET nik='$nik',nama='$nama',jabatan='$jabatan',loker='$loker' WHERE nik='$nik'";
echo mysql_error();
        mysql_query($hasil);
        if (mysql_affected_rows() > 0)
             print("Data dengan NIK = $nik dan NAMA = $nama sudah diubah ke dalam database dengan benar dan sukses");
        else
