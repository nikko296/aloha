...
border=0 width="1005">
  ...
  <TR vAlign=top bordercolor="1" border="1">
    ...
    <TD width="1000" vAlign=top bordercolor="1" align="center"><div align="center"><BR>
                  ...
                  <TBODY>
                    <TR>
                      <TD width="975"><div align="center"><font color="#800000">
						<b>HAPUS DATA PEGAWAI</b></font></div>    
      ...
      bgColor=#6487dc border=0 height="73">
            <TBODY>
              <TR>
                <TD height="71">
				<FORM method="post" action="hapus_data_pegawai.php">
    ...
    <td width="20%" height="1">
         ...
         <p align="center"><font size="2"><input type="text" name="input1" size="20"></font></td>
...
require("koneksi.php");
      ...
      $sql = "select nik,nama,jabatan,loker from tabel_pegawai  where nik like '%$input1%' and nama like '%$input2%' order by loker";
...
?>
         <font size="1">
<?php
         print("<CENTER><A HREF=\"simpan_hapus_data_pegawai.php?kode=$kode1\">");
         print("HAPUS PEGAWAI </A></CENTER>");
?>
       </font>
<?php
         print("</TD>");
