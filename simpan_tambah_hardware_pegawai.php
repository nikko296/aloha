...
if (!mysql_select_db($dbname,$link))
          ...
          $tgl = explode("/",$tgl_perolehan);
          $tgl_perolehan1.=$tgl[2]."/".$tgl[1]."/".$tgl[0];
         echo "$tgl_perolehan1";
        
           $hasil = mysql_query("select * from master_hw where no_sn like '$no_sn'", $link);
        ...
        $hasil = "INSERT INTO master_hw (nik,no_sn,jenis_hw,merk_hw,type_hw,spesifik_hw,tgl_perolehan,nilai_perolehan,lokasi,pakai,keterangan) values ('$nik','$no_sn','$jenis_hw','$merk_hw','$type_hw','$spesifik_hw','$tgl_perolehan1','$nilai_perolehan','$lokasi','$pakai','$keterangan')";
