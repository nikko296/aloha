...
require ("koneksi.php");
      ...
      $sql = "delete from tabel_pegawai where nik like '$kode'";


      if (mysql_query ($sql,$link))
          print("Data dengan NIK = $kode sudah dihapus dari Database dengan benar dan sukses");
      else
          print("Data dengan NIK = $kode gagal dihapus dari Database");
     mysql_close($link);
